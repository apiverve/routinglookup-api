# Routing Number Lookup Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:routinglookup-api:1.1.13'
}
```
...
```java
import com.apiverve.routinglookup.RoutingNumberLookupAPIClient;
import com.apiverve.routinglookup.APIResponse;
import com.apiverve.routinglookup.APIException;

// Initialize the client
RoutingNumberLookupAPIClient client = new RoutingNumberLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("routing", "121000358");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/routinglookup](https://docs.apiverve.com/ref/routinglookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/routinglookup](https://docs.apiverve.com/ref/routinglookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/routinglookup-api/issues)
