...
class routinglookupWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/routinglookup');
        }
        ...
        this.validationRules = {"routing":{"type":"string","required":true,"minLength":9,"maxLength":9}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/routinglookup`);
        }
    }
...
module.exports = routinglookupWrapper;
