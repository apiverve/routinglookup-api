...
{
    class RoutingNumberLookupExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/routinglookup";

        /// <summary>
        /// Make a GET request to the Routing Number Lookup API
        /// </summary>
        static async Task<JsonDocument> CallRoutingNumberLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;routing&quot;] &#x3D; &quot;121000358&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Routing Number Lookup API...\n");

            var result = await CallRoutingNumberLookupAPI();
