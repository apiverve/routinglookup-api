...
const (
	baseURL        = "https://api.apiverve.com/v1/routinglookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Routing Number Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Routing Number Lookup API client.
...
// Execute makes a request to the Routing Number Lookup API with typed parameters.
//
