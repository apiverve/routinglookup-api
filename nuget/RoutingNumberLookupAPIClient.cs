...
namespace APIVerve.API.RoutingNumberLookup
{
    ...
    /// <summary>
    /// Client for the RoutingNumberLookup API
    /// </summary>
    public class RoutingNumberLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/routinglookup";
        ...
        {
            { "routing", new ValidationRule { Type = "string", Required = true, MinLength = 9, MaxLength = 9 } }
        };
        ...
        public RoutingNumberLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RoutingNumberLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RoutingNumberLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RoutingNumberLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RoutingNumberLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(RoutingNumberLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RoutingNumberLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RoutingNumberLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RoutingNumberLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RoutingNumberLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RoutingNumberLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RoutingNumberLookupQueryOptions options)
        {
