...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/routinglookup',
        'Source': 'https://github.com/apiverve/routinglookup-api',
        'Bug Tracker': 'https://github.com/apiverve/routinglookup-api/issues'
    },
    classifiers=[
